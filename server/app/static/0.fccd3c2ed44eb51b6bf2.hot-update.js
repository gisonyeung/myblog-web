	...
	*/
	...
	var Pagination = function (_Component) {
	  ...
	  _createClass(Pagination, [{
	    key: 'onChange',
	    value: function onChange(nextPage) {
	    ...
	    value: function render() {
	      ...
	      for (var i = 2; i < this.props.total; i++) {
	        ...
	        item = _react2.default.createElement(
	          'span',
	          { key: i, className: 'page-number', activeClassName: 'active', onClick: this.onChange.bind(this, i) },
	          i
	        );
	        items.push(item);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BlogListPanel = function (_Component) {
	  ...
	  function BlogListPanel(props) {
	    ...
	    props.initPage(props.query.page);
	    props.changePage(props.query.page);
