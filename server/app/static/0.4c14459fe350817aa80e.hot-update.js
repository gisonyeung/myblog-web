...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BlogItem = __webpack_require__(222);
	...
	var BlogListPanel = function (_Component) {
	  ...
	  function BlogListPanel(props) {
	    ...
	    props.initPage(_this.props.query.page);
	    props.changePage(_this.props.query.page);
	  ...
	  _createClass(BlogListPanel, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      props.changePage(nextProps.query.page);
	    }
	  }, {
	    key: 'render',
	    ...
	    value: function onPageChange(nextPage) {
	      ...
	      blogAction.changePage(nextPage);
	    }
	  }]);
