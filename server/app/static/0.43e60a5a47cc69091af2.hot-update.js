...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetch = __webpack_require__(/*! ../utils/fetch */ 101);
	
	var _fetch2 = _interopRequireDefault(_fetch);
	
	var _constants = __webpack_require__(/*! ../constants */ 35);
	
	var _Api = __webpack_require__(/*! ../constants/Api */ 100);
	...
	var addSubscribe = function addSubscribe(formData) {
	  return function (dispatch) {
	    ...
	    dispatch(network.requestAction(_constants.Site.REQUEST_SUBSCRIBE));
	    _fetch2.default.POST(_Api2.default.addSubscribe, formData).then(function (data) {
	      if (data.result !== 'success') {
	        dispatch(network.failAction(_constants.Site.FAILED_SUBSCRIBE, data.reason));
	        return false;
	      }
	      dispatch(network.receiveAction(_constants.Site.RECEIVE_SUBSCRIBE));
	    }).catch(function (err) {
	      dispatch(network.failAction(_constants.Site.FAILED_SUBSCRIBE, err));
	    });
	  };
	};
...
//# sourceMappingURL=0.43e60a5a47cc69091af2.hot-update.js.map