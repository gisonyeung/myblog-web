	...
	var SubscribeModal = function (_Component) {
	  ...
	  _createClass(SubscribeModal, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      //   this.refs.subNickname.value = '';
	      //   this.refs.subEmail.value = '';
	      // }
	      ...
	      this.setState({
	        isTip: {
	          status: !!nextProps.fetchStatus.status && nextProps.fetchStatus !== _constants.Status.FETCHING,
...
//# sourceMappingURL=0.d7775e2893b56e30dff8.hot-update.js.map